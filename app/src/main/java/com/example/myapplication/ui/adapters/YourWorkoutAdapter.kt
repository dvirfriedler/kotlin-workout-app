...
class YourWorkoutAdapter :
    ListAdapter<YourWorkout, YourWorkoutAdapter.WorkoutViewHolder>(WorkoutDiffCallback()) {

    private var onItemClickListener: ((YourWorkout) -> Unit)? = null

    fun setOnItemClickListener(listener: (YourWorkout) -> Unit) {
    ...
    inner class WorkoutViewHolder(private val binding: WorkoutItemBinding) :
        ...
        fun bindWorkoutData(workout: YourWorkout) {
            with(binding) {
        ...
        fun addButtonClickListener(workout: YourWorkout) {
        ...
        private fun createButton(): ImageButton {
            ...
            val iconResId = R.drawable.trash_icon
        ...
        private fun setButtonClickListener(button: ImageButton, workout: YourWorkout) {
            button.setOnClickListener {

                showRemoveItemDialog(binding.root, workout.name) { isOkClicked ->
                    if (isOkClicked) {
    ...
    private fun showRemoveItemDialog(
        ...
        val title = context.getString(R.string.ex_remove)
        val toastMessage = "$ex_name ${context.getString(R.string.was_removed)}"
    ...
    private class WorkoutDiffCallback : DiffUtil.ItemCallback<YourWorkout>() {
        override fun areItemsTheSame(oldItem: YourWorkout, newItem: YourWorkout): Boolean {
            return oldItem.id == newItem.id
        }

        override fun areContentsTheSame(oldItem: YourWorkout, newItem: YourWorkout): Boolean {
